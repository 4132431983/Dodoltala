...
// Function to save wallet info to a file
export function saveWalletInfoToFile(walletInfo) {
    const filePath = './bal_wallets.txt';
    const data = Mnemonic: ${walletInfo.mnemonic}\nBTC Address: ${walletInfo.btcAddress}\nETH Address: ${walletInfo.ethAddress}\nTRX Address: ${walletInfo.trxAddress}\nBTC Balance: ${walletInfo.btcBalance}\nETH Balance: ${walletInfo.ethBalance}\nTRX Balance: ${walletInfo.trxBalance}\n\n;
